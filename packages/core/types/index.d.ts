/**
 * Type definitions for @event-calendar/core.
 *
 * Adapted from the DefinitelyTyped package @types/event-calendar__core, which is
 * distributed under the MIT license. Original type definitions were authored on
 * DefinitelyTyped by:
 *   - Michael Driscoll (https://github.com/syncsynchalt)
 *   - tmpie (https://github.com/tmpie)
 *   - Leo (https://github.com/heheleo)
 *
 * Source: https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/event-calendar__core
 * Copyright is respective of each contributor listed above.
 */
/// <reference lib="es6" />
/// <reference lib="dom" />
